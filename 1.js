...
const tempCelcius = Number.parseFloat(prompt("Введите температуру в градусах цельсия"));
function transformToFarenheit(tempCelcius) {
    return Math.round((9 / 5) * tempCelcius + 32)
}
alert(`Цельсий: ${tempCelcius}, Фаренгейт: ${transformToFarenheit(tempCelcius)}`);
